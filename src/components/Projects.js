...
class Projects extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className= "drop-down">
      <Input onChange={handleChange}  className="input-form main-value name-project" id="name-project" type="text" name="nameProject2" placeholder="Nombre del proyecto" value={this.props.data.nameProject2} deleteState={this.props.deleteState} required />
