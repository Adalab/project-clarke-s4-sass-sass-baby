...
class Experience extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Input onChange={handleChange} className="input-form date-start-education" type="date" name="startDateExperience" placeholder="Fecha inicio" value={this.props.data.startDateExperience} deleteState={this.props.deleteState} required={true}/>
      <Input onChange={handleChange} className="input-form date-end-education" type="date" name="finishDateExperience" placeholder="Fecha fin" value={this.props.data.finishDateExperience} deleteState={this.props.deleteState} required={true}/>
      ...
      <Input onChange={handleChange} className="input-form date-start-experience" id="init-data-experience" type="date" name="startDateExperience2" value={this.props.data.startDateExperience2} deleteState={this.props.deleteState} required={true}/>
      <Input onChange={handleChange} className="input-form date-end-experience" id="finish-data-experience" type="date" name="finishDateExperience2" value={this.props.data.finishDateExperience2} deleteState={this.props.deleteState} required={true}/>
