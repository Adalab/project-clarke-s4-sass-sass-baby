      ...
      <Fieldset title="Formación">
        <Colapsable box= "firstEducationBox" link="Añadir formación 1" ref="firstEducationBox">
          <div className="drop-down">
            <Input onChange={handleChange} className="input-form title-education main-value" type="text" name="titleEducation" placeholder="Título" value={this.props.data.titleEducation} deleteState={this.props.deleteState} required={true} />
            ...
            <input onChange={handleChange} className="input-form date-start-education" type="date" name="startDateEducation" placeholder="Fecha inicio"/>
            <input onChange={handleChange} className="input-form date-end-education" type="date" name="finishDateEducation" placeholder="Fecha fin"/>
          </div>
        </Colapsable>
